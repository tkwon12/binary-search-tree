"""
BST (Variant): insertion may replace the current root when the inserted key lies
between the max key in the left subtree and the min key in the right subtree.

This file includes:
- Node definition
- dump(): debug-friendly JSON serializer
- insert/delete/search operations for the variant BST
"""
